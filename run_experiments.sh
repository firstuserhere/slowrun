...
submit() {
    ...
    case "${1:-swiglu}" in
        ...
        baseline)
            ...
            ;;
        combo)
            echo "Config: SwiGLU + VE proj + WD 1.6 (12 epochs)"
            run_one "submit-combo-wd16" \
                --num-epochs=12 --swiglu --ve-proj --weight-decay=1.6 $BASELINE
            ;;
        combo14)
            echo "Config: SwiGLU + VE proj + WD 1.6 (14 epochs)"
